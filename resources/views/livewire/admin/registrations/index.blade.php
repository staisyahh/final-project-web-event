                                                ...
                                                @if($reg->status === 'pending_payment')
                                                    <x-ui.button 
                                                        ...
                                                        @click="$dispatch('swal:confirm', {
                                                            ...
                                                            text: 'Anda yakin ingin mengkonfirmasi pembayaran untuk registrasi #{{ $reg->id }}?',
                                                            icon: 'question',
                                                            confirmButtonText: 'Ya, Konfirmasi!',
                                                            onConfirm: {
                                                                event: 'update-registration-status',
                                                                params: { id: {{ $reg->id }}, status: 'confirmed' }
                                                            }
                                                        })"
                                                        title="Konfirmasi Pembayaran"
                                                    >
                                                    ...
                                                    <x-ui.button 
                                                        ...
                                                        @click="$dispatch('swal:confirm', {
                                                            ...
                                                            text: 'Anda yakin ingin membatalkan pesanan untuk registrasi #{{ $reg->id }}?',
                                                            icon: 'warning',
                                                            confirmButtonText: 'Ya, Batalkan!',
                                                            onConfirm: {
                                                                event: 'update-registration-status',
                                                                params: { id: {{ $reg->id }}, status: 'cancelled' }
                                                            }
                                                        })"
                                                        title="Batalkan Pesanan"
                                                    >
