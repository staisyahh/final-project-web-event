                    ...
                    @forelse ($events as $event)
                        <div class="col-12 col-md-6 col-lg-4 mb-4" wire:key="event-card-{{ $event->id }}">
                            <div class="card h-100">
                                ...
                                <a wire:navigate href="{{ route('event.detail', $event->slug) }}">
                                    <img src="{{ $event->banner_url ? asset('storage/' . $event->banner_url) : 'https://via.placeholder.com/400x200.png?text=No+Image' }}" class="card-img-top" alt="{{ $event->title }}" style="height: 200px; object-fit: cover;">
                                </a>
                                <div class="card-body d-flex flex-column">
                                    ...
                                    <div class="mb-2">
                                        ...
                                        @endphp
                                        <a wire:navigate href="{{ route('event.detail', $event->slug) }}" class="text-decoration-none">
                                    ...
                                    {{-- Title (clickable) --}}
                                    <a wire:navigate href="{{ route('event.detail', $event->slug) }}" class="text-decoration-none text-dark">
